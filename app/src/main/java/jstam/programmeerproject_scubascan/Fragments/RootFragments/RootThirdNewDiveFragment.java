...
public class RootThirdNewDiveFragment extends Fragment {
    ...
    public static RootThirdNewDiveFragment newInstance(int page) {

        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        RootThirdNewDiveFragment fragment = new RootThirdNewDiveFragment();
...
//        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		 ...
		 * "real" fragment
		 */
        transaction.replace(R.id.root_frame_third, new ThirdNewDiveFragment());
