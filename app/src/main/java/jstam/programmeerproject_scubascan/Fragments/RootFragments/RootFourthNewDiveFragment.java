...
public class RootFourthNewDiveFragment extends Fragment {
    ...
    public static RootFourthNewDiveFragment newInstance(int page) {

        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        RootFourthNewDiveFragment fragment = new RootFourthNewDiveFragment();
...
//        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		 ...
		 * "real" fragment
		 */
        transaction.replace(R.id.root_frame_fourth, new FourthNewDiveFragment());
